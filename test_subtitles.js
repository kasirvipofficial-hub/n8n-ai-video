/**
 * Test FFmpeg Server — Animated Subtitles (Advanced)
 * Tests: 
 * 1. Long Text Wrapping
 * 2. Speed Sync (2x speed)
 * 3. Dynamic Resolution (1080x1920)
 * 4. Emoji Support (if Noto is loaded)
 */
...
async function main() {
    console.log('=== FFmpeg Advanced Subtitles Test ===\n');
    ...
    const jobId = `adv-sub-${Date.now()}`;
    const srtContent = `1
00:00:00,500 --> 00:00:02,000
Start: Testing Wrappping Behavior for very long lines that should break automatically

2
00:00:02,500 --> 00:00:05,000
Emoji Test: 🚀 🔥 ✨ (Should display if font loaded)

3
00:00:05,000 --> 00:00:07,000
Sync Test: This should appear at 2.5s if speed is 2x`;
    ...
    console.log('Subtitle Config:');
    console.log('  Speed: 2.0x (Expect 50% duration)');
    console.log('  Testing: Wrapping, Emoji, Sync');
    console.log('  Font: Poppins Bold 48px Yellow\n');
